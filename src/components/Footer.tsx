    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs leading-relaxed">India&apos;s premium commercial real estate platform. Retail, Office, Co-working &amp; Investment spaces.</p>
            <div className="flex gap-2.5 mt-3">
              ...
              <a href="https://www.instagram.com/fourpsrealty" target="_blank" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors text-gray-600" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/fourpsrealty" target="_blank" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors text-gray-600" aria-label="LinkedIn">
          ...
          <div>
            ...
            <div className="space-y-2.5">
              ...
              <a href="mailto:info@fourps.in" className="flex items-center gap-2 text-gray-500 text-xs hover:text-blue-600 transition-colors">
                ✉️ info@fourps.in
              </a>
      ...
      <div className="border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-1">
          <p className="text-gray-400 text-xs">© {new Date().getFullYear()} FourPs Realty Services. All rights reserved.</p>
