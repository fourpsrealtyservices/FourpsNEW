  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <a
        href={`https://wa.me/${WHATSAPP_NUMBER}?text=${getWhatsAppEnquiryMessage()}`}
        target="_blank"
        className="fixed bottom-6 right-6 bg-green-500 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-xl shadow-green-500/30 hover:bg-green-600 hover:scale-110 transition-all z-50"
