...
export interface FieldDefinition {
  key: string;
  label: string;
  type: 'text' | 'number' | 'textarea' | 'dropdown' | 'multi-checkbox';
  unit?: string;
  options?: string[];
  placeholder?: string;
}
...
export const CATEGORY_FIELDS: Record<string, FieldDefinition[]> = {
  ...
  lease_retail: [
    ...
    { key: 'expectedRent', label: 'Expected Rent', type: 'text', placeholder: 'Per sq ft OR full floor/unit amount' },
  ...
  // Lease - Office (same for furnished/unfurnished, field display differs)
  lease_office: [
    { key: 'locationArea', label: 'Location / Area', type: 'text', placeholder: 'Area / locality name' },
    ...
    { key: 'floor', label: 'Floor', type: 'dropdown', options: ['Ground', 'Basement', '1st', '2nd', '3rd', '4th', '5th', '6th+', 'Terrace'] },
    { key: 'roadWidth', label: 'Road Width in Front', type: 'number', unit: 'ft' },
    { key: 'expectedRent', label: 'Expected Rent', type: 'text', placeholder: 'Per sq ft OR full floor amount' },
    { key: 'buildingStatus', label: 'Building Status', type: 'dropdown', options: ['Ready to Move In', 'Under Construction', 'About to Vacate'] },
  ...
  lease_coworking: [
    ...
    { key: 'parking', label: 'Parking', type: 'text', placeholder: 'Available / Not Available / Details' },
    { key: 'seatsAvailable', label: 'Number of Seats Available', type: 'number', unit: 'seats' },
    ...
    { key: 'expectedRentPerSeat', label: 'Expected Rent / Seat', type: 'text', placeholder: 'Per seat per month' },
    { key: 'description', label: 'Description', type: 'textarea', placeholder: 'Free-text summary' },
  ],
  ...
  lease_commercial_plot: [
    ...
    { key: 'expectedRent', label: 'Expected Rent', type: 'text', placeholder: 'Per sq yard or total' },
    { key: 'description', label: 'Description', type: 'textarea', placeholder: 'Free-text summary' },
  ],
  ...
  sale_retail: [
    ...
    { key: 'floor', label: 'Floor', type: 'dropdown', options: ['Ground', 'Basement', '1st', '2nd', '3rd', '4th', '5th', '6th+', 'Terrace'] },
    { key: 'roadWidth', label: 'Road Width in Front', type: 'number', unit: 'ft' },
    { key: 'expectedSalePrice', label: 'Expected Sale Price', type: 'text', placeholder: 'Per sq ft OR total amount' },
  ...
  sale_office: [
    ...
    { key: 'floor', label: 'Floor', type: 'dropdown', options: ['Ground', 'Basement', '1st', '2nd', '3rd', '4th', '5th', '6th+', 'Terrace'] },
    { key: 'roadWidth', label: 'Road Width in Front', type: 'number', unit: 'ft' },
    { key: 'expectedSalePrice', label: 'Expected Sale Price', type: 'text', placeholder: 'Per sq ft OR total' },
    { key: 'buildingStatus', label: 'Building Status', type: 'dropdown', options: ['Ready to Move In', 'Under Construction'] },
  ...
  sale_land_plot: [
    ...
    { key: 'dimensions', label: 'Dimensions', type: 'text', placeholder: 'e.g. 50 ft x 100 ft' },
    { key: 'roadWidth', label: 'Road Width in Front', type: 'number', unit: 'ft' },
    { key: 'expectedSalePrice', label: 'Expected Sale Price', type: 'text', placeholder: 'Per sq yard or total' },
  ...
  sale_investment: [
    ...
    { key: 'expectedPrice', label: 'Expected Price', type: 'text', placeholder: 'Total investment value' },
